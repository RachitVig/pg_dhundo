  ...
  return (
    <div className="min-h-screen bg-[#FAFBFF] pt-28 pb-20 px-6">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          <div className="mb-10">
             <h3 className="text-3xl font-black uppercase tracking-tight text-slate-900">Sign In</h3>
             <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mt-1">Premium PG Network Access</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
             <button type="button" onClick={() => {
                login({ name: "Admin Google User", email: "admin@pgdhundo.com" });
                setCurrentView('home');
